...
nbreSimul= 50; %10; % 30; 50;
%refaire avec 30 simuls pr améliorer l'intervalle de confiance
fileDat='arrive*.dat';
        ...
        %  bbbb= sum(prob2AVG)
          ...
          sommm2=0;
           for indddeee=1:(Buffer+1) 
               sommm1=sommm1+prob1AVG(indddeee);
               sommm2=sommm2+prob2AVG(indddeee);
               fprintf(fiAVGdistr, '%g \t %g \t %g  \t %g   \t %g  \t %g \t %g \n', indddeee, prob1AVG(indddeee),  ajustBuf1(indddeee), sommm1, prob2AVG(indddeee), ajustBuf2(indddeee), sommm2 );
           end
           fclose(fiAVGdistr);
