...
%           [RB_usedOK indexC1, indexC2]= setdiff(cell{q,ta}.rbUserPris, tabRBbb);            %indexCell1: permet d'avoir les indexes au sein de la celle q
...
%                     end
%                           cell{q,t}.RB(rbChoix).SINR = calculSINR(cell{q,ta}.RB(rbChoix).dist, 0 , PuisUsed(q,rbChoix), beta, noise);
%                           cell{q,t}.RB(rbChoix).Throughput = W * log(1 + cell{q,t}.RB(rbChoix).SINR);
%                           
%                           
%                   
%               end
...
%           end             
                  ...
                  if (newRB ~= wwRbConfli)
                    ...
                    if ((cell{q,t}.RB(newRB).SINR - cell{q,t}.RB(wwRbConfli).SINR) >= epsilon)   
