...
%TTI 1 ms le service
function [ time Ar instantGener cumulArrive ] = expoGener2(lambda,  N, TTI, B, Buffer) %instantGener
i=1;
cpt=0;
j=1;
t3=zeros(1,N);
...
%%%%%%%%%%%%%%%%%%%%%%
OutputFile= strcat('arriveFiles.dat'); %pr sauvegarder les attentes et transmis
fiArrivee = fopen(OutputFile, 'w');  %wt
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
OutputFileGene= strcat('instantsGener.dat'); %pr stocker les attentes et transmis
