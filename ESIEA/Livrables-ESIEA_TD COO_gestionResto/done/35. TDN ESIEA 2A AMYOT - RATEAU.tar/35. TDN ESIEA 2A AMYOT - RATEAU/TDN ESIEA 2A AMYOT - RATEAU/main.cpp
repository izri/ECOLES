...
using namespace std; // toujours de le cpp pas le hpp
...
int main()
{
 ...
 string addition("Prix du repas: ");
   ...
   string nomclient;
	...
	Client clt1("Edouard"), clt2("Julien");
	clt1.afficherInfo();
	clt2.afficherInfo();
	cout<<"Les deux clients sont Edouard et Julien"<< endl;

       cout<<endl<<"Entrez nom du client:"<< endl;
...
pizza3("Calzone", 15);
 ...
 int max=0;
  ...
  max=count[0];
	...
	if(max==count[2]){
		cout<<"Best-seller Margarita"<< endl;
	...
	if(max==count[3]){
		cout<<"Best-seller Lasagnes Vegetariennes"<< endl;
          
	
	}

	if(max==count[4]){
		cout<<"Best-seller Quiche Vegetarienne"<< endl;
	...
	if(max==count[5]){
		cout<<"Best-seller Couscous"<< endl;
	...
	if(max==count[6]){
		cout<<"Best-seller Coca Cola"<< endl;
	...
	if(max==count[8]){
		cout<<"Best-seller Eau Plate"<< endl;
	...
	if(max==count[9]){
		cout<<"Best-seller Gateau Chocolat"<< endl;
          
	
	}

	if(max==count[10]){
		cout<<"Best-seller Glace Vanille"<< endl;
	...
	if(max==count[11]){
		cout<<"Best-seller Glace Framboise"<< endl;
	...
	outFile<<"Historique des prix du client Julien dans TotalJu.txt: "<<endl;

	}



	if(nomclient=="Edouard"){
		
	outFile<<"Historique des prix du client Edouard dans TotalEd.txt: "<<endl;

	}


/*************Fichier Julien Historique Prix*************/
	...
	if(nomclient=="Julien"){
        ...
        outFile1.open("TotalJu.txt",ios::out| ios::app);
	...
	/*************Fichier Edouard Historique Prix*************/
	...
	if(nomclient=="Edouard"){
        ...
        outFile2.open("TotalEd.txt",ios::out| ios::app);
